...
export default function Violations() {
    ...
    const {
        ...
        violations, total, page, pages, loading,

        filters, setFilter, clearFilters, setPage,

        fetchViolations, deleteViolation,
    ...
    }, [filters.camera_id, filters.violation_type, filters.date_from, filters.date_to])
    ...
    const exportCSV = () => {
        ...
        const headers = ['Camera ID', 'Violation Type', 'Plate', 'Confidence', 'Detected At']
    ...
    return (
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-4">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-6 gap-3">
                    ...
                    >
                        ...
                        <option value="CO_RIDING_NO_HELMET">Co-rider No Helmet</option>
            ...
            <p className="text-xs text-gray-400 text-center">{total} total violations</p>
                ...
                >
                    ...
                    >
                        <div className="flex items-center justify-between p-5 border-b border-gray-100">
                            <div>
                                <h3 className="text-sm font-bold text-gray-900">Delete violation?</h3>
                        ...
                        <div className="p-5 space-y-3">
                            <div className="text-sm text-gray-700">
                                <div className="flex justify-between gap-4">
                                    ...
                                    <span className="font-medium">{deleteTarget.camera_id || '—'}</span>
                                </div>
                                <div className="flex justify-between gap-4">
                                    <span className="text-gray-400">Track</span>
                                    <span className="font-medium">#{deleteTarget.track_id ?? '—'}</span>
                                </div>
                                <div className="flex justify-between gap-4">
                                    <span className="text-gray-400">Type</span>
                                    <span className="font-medium">{deleteTarget.violation_type?.replace(/_/g, ' ') || '—'}</span>
                                </div>
                                <div className="flex justify-between gap-4">
                                    <span className="text-gray-400">Plate</span>
                                    <span className="font-mono font-medium">{deleteTarget.plate_text || 'UNDETECTED'}</span>
                                </div>
                            </div>
