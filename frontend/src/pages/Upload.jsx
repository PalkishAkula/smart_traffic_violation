...
export default function Upload() {
            ...
            <div className="space-y-6">
                ...
                <div className="bg-green-50 border border-green-200 rounded-2xl p-5 flex items-center gap-3">
                    ...
                    <p className="text-sm font-semibold text-green-800">
                        ✓ Done — {violations.length} violation{violations.length !== 1 ? 's' : ''} detected
                    </p>
                </div>
                ...
                {logLines.length > 0 && (
                    <details className="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                        <summary className="px-5 py-3 text-sm font-semibold text-gray-700 cursor-pointer hover:bg-gray-50">
                            Model Logs ({logLines.length} lines)
                        </summary>
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-6 max-w-xl mx-auto space-y-5">
                    ...
                    <div className="flex flex-col items-center text-center gap-3 py-4">
                        ...
                        <div>
                            <p className="text-base font-semibold text-gray-800">Analyzing video…</p>
                            {totalFrames > 0 && (
                                <p className="text-sm text-gray-500 mt-1">
                                    Frame {currentFrame}/{totalFrames} · {currentFps.toFixed(1)} FPS
                                </p>
                            )}
                        </div>
                    </div>
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-2xl font-bold text-gray-900">Upload Video</h1>
            <p className="text-sm text-gray-500">Upload a traffic camera video to detect motorcycle violations</p>
          ...
          `}
                ...
                >
                    ...
                    {file ? (
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-300 mt-2">Supports MP4, AVI, MOV, MKV (max 500 MB)</p>
                        </div>
                    )}
                </div>
                ...
                {uploading && (
                    <div className="mt-4">
                        ...
                        <p className="text-xs text-gray-500 text-right mt-1">Uploading… {uploadProgress}%</p>
                    </div>
                )}
