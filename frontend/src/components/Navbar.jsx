...
const navItems = [
  ...
  { path: "/cameras", key: "Cameras", icon: Camera },
  { path: "/upload", key: "Upload", icon: Upload },
  { path: "/violations", key: "Violations", icon: AlertTriangle },
  { path: "/instructions", key: "Instructions", icon: BookOpen },
];
